...
public class givePlayerCoins100 implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 1) {
            player.sendMessage("Usage: /givecoins100 <amount>");
            return true;
        }
        ...
        player.getInventory().addItem(customMoney.create100coinItem(amount));
        return true;
    }
}
