...
public class givePlayerCoins1 implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 1) {
            player.sendMessage("Usage: /givecoins1 <amount>");
            return true;
        }
        ...
        player.getInventory().addItem(customMoney.create1coinItem(amount));
        return true;
    }
}
