...
public class givePlayerCoins1000 implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 1) {
            player.sendMessage("Usage: /givecoins1000 <amount>");
            return true;
        }
        ...
        player.getInventory().addItem(customMoney.create1000coinItem(amount));
        return true;
    }
}
